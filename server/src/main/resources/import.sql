...
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (1, '2018-07-07', '2018-07-07', 1, true, 10, 20, 'RSD', '11', '222-1234567890123-22', 2, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (2, '2018-06-06', '2018-06-06', 2, false, 30, 40, 'RSD', '22', '333-1234567890123-33', 3, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (3, '2018-05-05', '2018-05-05', 1, false, 50, 60, 'EUR', '33', '444-1234567890123-44', 3, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (4, '2018-04-04', '2018-04-04', 5, true, 70, 80, 'USD', '44', '555-1234567890123-55', 1, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (5, '2018-03-03', '2018-03-03', 3, true, 90, 10, 'EUR', '55', '666-1234567890123-66', 4, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (6, '2018-02-02', '2018-02-02', 4, false, 20, 30, 'CHF', '66', '777-1234567890123-77', 5, 'naplata duga');
INSERT INTO nalog_za_placanje (id, datum_naloga, datum_valute, duznik_id, hitno, model_odobrenja, model_zaduzenja, oznaka_valute, poziv_na_broj_odobrenja, poziv_na_broj_zaduzenja, primalac_id, svrha) values (7, '2018-01-01', '2018-01-01', 5, true, 40, 50, 'RSD', '77', '888-1234567890123-88', 2, 'naplata duga');
