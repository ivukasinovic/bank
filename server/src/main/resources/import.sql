...
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (1,25,100,'2018-07-02','2018-07-24','ULAZNA',25,10,200,true,1,5,1,1);
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (2,20,101,'2018-07-05','2018-07-14','IZLAZNA',26,100,400,true,2,4,2,1);
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (3,21,102,'2018-07-06','2018-07-19','ULAZNA',27,80,122,true,3,5,6,2);
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (4,22,103,'2018-07-07','2018-07-04','IZLAZNA',28,0,40,true,4,5,7,3);
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (5,23,104,'2018-07-08','2018-07-22','ULAZNA',29,0,510,true,null,5,8,3);
INSERT INTO faktura (id, bezpdv, broj, datum, datum_valute,tip,ukupanpdv, ukupan_rabat,ukupno_za_placanje,zatvorena,narudzbenica_id,poslovna_godina_id,poslovni_partner_id,preduzece_id) VALUES (6,24,105,'2018-07-09','2018-07-23','IZLAZNA',30,12,480,true,null,9,3,1);
